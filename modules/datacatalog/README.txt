This module creates a custom search page and then access to data in a different
database to make them queryable.

Original author: ptalexander@wisc.edu  (personal: preston.t.alexander@gmail.com )
--------------------------------------------------------------------------------
datacatalog.inc
